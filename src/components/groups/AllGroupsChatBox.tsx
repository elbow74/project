...
interface AllGroupsChatBoxProps {
  onClose?: () => void;
}
...
export function AllGroupsChatBox({ onClose }: AllGroupsChatBoxProps) {
        ...
        {messages.length === 0 && (
          <div className="text-center py-8">
            ...
            <p className="text-sm text-gray-400">
              Ask me about common times across all your groups
            </p>
            <p className="text-xs text-gray-500 mt-1">
              Try: "When is everyone available across all groups next week?"
            </p>
          </div>
        )}
      ...
      <div className="p-3 border-t border-gray-700 bg-gray-900/50">
        <div className="flex gap-2">
          <input
            ...
            placeholder="Ask about common times across all groups..."
            disabled={isLoading}
